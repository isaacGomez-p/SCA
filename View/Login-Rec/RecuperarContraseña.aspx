            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style5" rowspan="10">LOGIN<br />
                        <br />
                        <asp:Label ID="Label2" runat="server" CssClass="auto-style9" ForeColor="White" Text="Digite su nueva contraseña:"></asp:Label>
                        <br />
                        <asp:TextBox ID="Tb_Contraseña" runat="server"></asp:TextBox>
                        <br />
                        <asp:Label ID="Label3" runat="server" CssClass="auto-style9" ForeColor="White" Text="Repita su nueva contraseña:"></asp:Label>
                        <br />
